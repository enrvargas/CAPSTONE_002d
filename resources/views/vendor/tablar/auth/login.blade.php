...
@section('content')
    <div class="container container-tight py-4">
                ...
                <form action="{{route('login')}}" method="post" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                               placeholder="TuCorreo@tweezers.com"
                               autocomplete="off">
                        @error('email')
                    ...
                    <a href="#" class="link-secondary" title="Show password" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                           ...
                           stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12"
                            ...
                            @error('password')
                            <div class="invalid-feedback">{{ 'Contrasena Incorrecta' }}</div>
                            @enderror
                        </div>
                    </div>
                    <div class="mb-2">
        ...
        <div class="text-center text-muted mt-3">
            Aun no tienes cuenta?<a href="{{route('register')}}" tabindex="-1">Registrate</a>
            <br>
            <br>
        </div>
