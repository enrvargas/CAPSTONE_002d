																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								...
																								<tr>
																									<td class="title-30 a-center pb-10" style="font-size:30px; line-height:34px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 10px;">
																										<multiline>
																											Hi "<?php echo e($patient["name"] . ' '.$patient["surname"]); ?>"
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																													...
																													<table width="100%" border="0" cellspacing="0" cellpadding="0">
																																...
																																<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: -90px;">
																																	<tr>
																																		<td class="img-center pb-20" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 20px;">
                                                                                                                                            ...
                                                                                                                                            <img src="<?php echo e($patient["avatar"]); ?>" width="110" height="110" editable="true" border="0" alt="" />    
                                                                                                                                            <?php else: ?>
																														...
																														<tr>
																															<td class="text-16 lh-26 a-center c-black" style="font-size:16px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; color:#282828;">
																																<multiline>
																																	<em>"ESPECIALIDAD : <?php echo e($patient["specialitie_name"]); ?>"</em>
                                                                                                                                    <br>
                                                                                                                                    <em>"HORA DE INICIO : <?php echo e($patient["hour_start_format"]); ?>"</em>
                                                                                                                                    <br>
                                                                                                                                    <em>"HORA DE FIN : <?php echo e($patient["hour_end_format"]); ?>"</em>
																																</multiline>
																															</td>
																														</tr>
																													</table>
...
<?php /**PATH C:\Users\user\Desktop\CURSOS UDEMY\Citas-Medicas-Udemy\api-clinica\resources\views/appointment_notification.blade.php ENDPATH**/ ?>